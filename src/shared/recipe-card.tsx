    ...
    >
      ...
      <div className="p-4 flex-1 flex flex-col gap-3">
        ...
        <Link
          to={`/recipe/${recipe.id}`}
          state={{ recipe }}
          className="w-full bg-gray-900 hover:bg-gray-800 dark:bg-gray-100 dark:hover:bg-gray-200 text-white dark:text-gray-900 font-medium py-3 px-4 rounded-full transition-colors text-center mt-auto text-sm tracking-wide uppercase"
        >
          Check out recipe
        </Link>
      </div>
